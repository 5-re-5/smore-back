...
public class StudyRoomRepositoryTest {
    ...
    void 삭제되지않은_스터디룸_최신순_조회() {
        // given
        StudyRoom room1 = new StudyRoom(10L, null, "첫 번째 스터디", StudyRoomCategory.EMPLOYMENT);
        StudyRoom room2 = new StudyRoom(11L, null, "두 번째 스터디", StudyRoomCategory.CERTIFICATION);
        StudyRoom room3 = new StudyRoom(12L, null, "세 번째 스터디", StudyRoomCategory.EMPLOYMENT);
    ...
    void 카테고리별_스터디룸_조회() {
        // given
        StudyRoom employmentRoom1 = new StudyRoom(20L, null, "취업 스터디 1", StudyRoomCategory.EMPLOYMENT);
        StudyRoom employmentRoom2 = new StudyRoom(21L, null, "취업 스터디 2", StudyRoomCategory.EMPLOYMENT);
        StudyRoom certificationRoom = new StudyRoom(22L, null, "자격증 스터디", StudyRoomCategory.CERTIFICATION);
    ...
    void 삭제된_스터디룸_제외_조회() {
        // given
        StudyRoom activeRoom = new StudyRoom(30L, null, "활성 스터디", StudyRoomCategory.EMPLOYMENT);
        StudyRoom roomToDelete = new StudyRoom(31L, null, "삭제될 스터디", StudyRoomCategory.EMPLOYMENT);
    ...
    void openVidu세션_할당_및_해제() {
        // given
        StudyRoom studyRoom = new StudyRoom(40L, null, "비디오 스터디", StudyRoomCategory.EMPLOYMENT);
    ...
    void 존재하지않는_카테고리_조회() {
        // given
        StudyRoom room = new StudyRoom(50L, null, "스터디", StudyRoomCategory.EMPLOYMENT);
